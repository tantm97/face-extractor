...
model_urls = {
    "iresnet18": "https://download.pytorch.org/models/resnet18-5c106cde.pth",
    "iresnet34": "https://download.pytorch.org/models/resnet34-333f7ec4.pth",
    "iresnet50": "https://download.pytorch.org/models/resnet50-19c8e357.pth",
}
...
def iresnet18(pretrained=False, progress=True, **kwargs):
    model = _iresnet("iresnet18", IBasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs)
    if pretrained:
...
def iresnet34(pretrained=False, progress=True, **kwargs):
    model = _iresnet("iresnet34", IBasicBlock, [3, 4, 6, 3], pretrained, progress, **kwargs)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["iresnet34"]))
    return model


def iresnet50(pretrained=False, progress=True, **kwargs):
    model = _iresnet("iresnet50", IBasicBlock, [3, 4, 14, 3], pretrained, progress, **kwargs)
    if pretrained:
